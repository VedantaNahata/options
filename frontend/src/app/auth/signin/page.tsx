        ...
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden" style={{ background: "#07080C" }}>
            ...
            >
                ...
                <div className="glass-card rounded-2xl p-8">
                    ...
                    <h1 className="text-2xl font-light text-white mb-2 tracking-[-0.02em]">Welcome back</h1>
                    <p className="text-[13px] text-[#6B6D78] mb-8">Sign in to your account to continue.</p>
                    ...
                    <p className="mt-6 text-center text-[13px] text-[#6B6D78]">
                        ...
                        <Link href="/auth/signup" className="text-[#A78BFA] hover:text-[#C4B5FD] transition-colors">
                            Sign up
                        </Link>
                    </p>
                </div>
